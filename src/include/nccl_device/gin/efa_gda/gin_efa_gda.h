...
/* ── Thread-exclusive Put (NCCL_GIN_RESOURCE_SHARING_THREAD): PoC ────
 *
 ...
 * straight to the SQ slot. Matches EfaCudaWrBuilder for the v0 wr_ctx layout
 * (remote_mem at byte 32, local_mem at byte 48). */
