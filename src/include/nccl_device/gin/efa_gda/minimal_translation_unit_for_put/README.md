...
Built against this branch's headers (base `f927d56a`) with
...
|---|---|
| `baseline` | `(none)` |
| `all` | `-DNCCL_GIN_EFA_GDA_SINGLE_ISSUER_PER_QP=1 -DNCCL_GIN_EFA_GDA_WQE_REGISTER_BUILD=1 -DNCCL_GIN_EFA_GDA_SINGLE_OWNER_FAST_PATH=1` |
| `nodoorbell` | `-DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_DOORBELL=1` |
| `nofence` | `-DNCCL_GIN_EFA_GDA_SINGLE_ISSUER_PER_QP=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_FENCE_A=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_DOORBELL=1` |
| `nommio` | `-DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_MMIO=1` |
| `nofence-nommio` | `-DNCCL_GIN_EFA_GDA_SINGLE_ISSUER_PER_QP=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_FENCE_A=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_MMIO=1` |
| `nofence-nommio-noatomic` | `-DNCCL_GIN_EFA_GDA_SINGLE_ISSUER_PER_QP=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_FENCE_A=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_MMIO=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_ATOMICS=1` |
| `nofence-nommio-noatomic-regwqe-nogroups` | `-DNCCL_GIN_EFA_GDA_SINGLE_ISSUER_PER_QP=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_FENCE_A=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_MMIO=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_ATOMICS=1 -DNCCL_GIN_EFA_GDA_WQE_REGISTER_BUILD=1 -DNCCL_GIN_EFA_GDA_EXPERIMENT_NO_GROUPS=1` |
